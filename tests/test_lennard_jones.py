...
class TestLennardJones:
    ...
    def test_minimum_property(self):
        ...
        assert E_overlap > E_random, "Overlapping atoms should have huge repulsion energy"
    ...
    def test_scaling_check(self):
        ...
        assert abs(val[0]) < 1.0, f"At large separation, energy should be near 0, got {val[0]}"
    ...
    def test_pair_interaction_explicit(self):
        ...
        assert np.isclose(val[0], -1.0, atol=1e-4), f"Expected -1.0 at equilibrium, got {val[0]}"
