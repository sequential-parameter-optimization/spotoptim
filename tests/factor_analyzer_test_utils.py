...
from spotoptim.factor_analyzer.factor_analyzer_utils import unique_elements
...
def calculate_py_output(
    ...
    Args:
        ...
        method (str): The rotation method.
        rotation (str): The type of rotation.
        svd_method (str, optional): The SVD method to use.
            Defaults to 'randomized'
        use_corr_matrix (bool, optional): Whether to use the correlation matrix.
            Defaults to ``False``.
        top_dir (str, optional): The top directory for test data.
            Defaults to ``DATA_DIR``

    Returns:
        output (dict): A dictionary containing the outputs for all ``OUTPUT_TYPES``.
    """
    if top_dir is None:
        top_dir = DATA_DIR
...
def collect_r_output(
    ...
    Args:
        test_name (str): The name of the test (e.g. 'test01')
        factors (int): The number of factors.
        method (str): The rotation method (e.g. 'uls')
        rotation (str): The type of rotation (e.g. 'varimax')
        output_types (list or None, optional): The types of outputs:
                - 'loading'
                - 'value'
                - 'evalues'
                - 'uniqueness'
    ...
    Returns:
        output (dict): A dictionary containing the outputs
...
def normalize(data, absolute=False):
    ...
    Args:
        data (pd.DataFrame): The data frame to normalize.
        absolute (bool, optional): Whether to take the absolute value of all elements in the data frame.
            Defaults to ``True``.

    Returns:
        data (pd.DataFrame): The normalized data frame.
    """
...
def check_close(
    ...
    Args:
        data1 (pd.DataFrame): The first data frame.
        data2 (pd.DataFrame): The second data frame.
        rel_tol (float, optional): The relative tolerance.
            Defaults to 0.0.
        abs_tol (float, optional): The absolute tolerance.
            Defaults to 0.1.
        absolute (bool, optional): Whether to take the absolute value of all elements in the data frame.
            Defaults to ``False``.

    Returns:
        check (float): The proportion that match.
    """
    if with_normalize:
...
def check_scenario(
    ...
    Args:
        ...
        method (str): The rotation method (e.g. 'uls')
        rotation (str): The type of rotation (e.g. 'varimax')
        ignore_value (bool, optional): Whether to ignore the "value" output type.
            Defaults to ``False``.
        ignore_communalities (bool, optional): Whether to ignore the "communalities" output type.
            Defaults to ``False``.
        check_scores (bool, optional): Check the factor scores.
            Defaults to ``False``.
        check_structure (bool, optional): Check the structure matrix. This should only be used with oblique
            rotations.
            Defaults to ``False``.
        use_corr_matrix (bool, optional): Whether to use the correlation matrix.
            Defaults to ``False``.
        data_dir (str, optional): The directory with input data files.
            Defaults to ``DATA_DIR``.
        expected_dir (str, optional): The directory with output files.
            Defaults to ``EXPECTED_DIR``.
        rel_tol (float, optional): The relative tolerance.
            Defaults to 0.0.
        abs_tol (float, optional): The absolute tolerance.
    ...
    Yields:
        check (float): The proportion that match between the calculated and expected.
    """
