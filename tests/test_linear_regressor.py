...
class TestLinearRegressorInitialization:
    ...
    def test_invalid_activation_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Activation function 'InvalidActivation' not found"):
...
class TestLinearRegressorArchitecture:
    ...
    def test_single_hidden_layer_architecture(self):
        ...
        activation_layers = [m for m in model.network.modules() if isinstance(m, nn.ReLU)]
...
class TestActivationFunctions:
    ...
    def test_various_activation_functions(self, activation):
        ...
        activation_layers = [m for m in model.network.modules() if isinstance(m, activation_class)]
        assert len(activation_layers) == 2  # Should have activation for each hidden layer
...
class TestModelTraining:
    ...
    def test_training_with_hidden_layers(self):
        ...
        model = LinearRegressor(input_dim=1, output_dim=1, l1=16, num_hidden_layers=2, activation="Tanh")
...
class TestEdgeCases:
    ...
    def test_high_dimensional_output(self):
        ...
        model = LinearRegressor(input_dim=10, output_dim=100, l1=32, num_hidden_layers=1)
