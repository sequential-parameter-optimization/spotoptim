...
class TestRefactoredOptimize:
    ...
    def test_run_sequential_loop_termination_iter(self, spot_optim):
        ...
        status, res = spot_optim._run_sequential_loop(
            timeout_start=time.time(), effective_max_iter=5
        )
    ...
    def test_optimize_integration_sequential(self):
        ...
        opt = SpotOptim(fun=sphere, bounds=[(-5, 5)], n_initial=3, max_iter=6, seed=42)
