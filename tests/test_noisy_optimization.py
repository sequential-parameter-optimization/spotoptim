...
class TestAggregatemeanVar:
    ...
    def test_aggregate_mean_var_multiple_repeats(self):
        ...
        np.testing.assert_array_almost_equal(y_var, np.array([expected_var1, expected_var2]))
    ...
    def test_aggregate_mean_var_no_duplicates(self):
        ...
        np.testing.assert_array_equal(y_var, np.zeros(3))  # No variance with single observations
