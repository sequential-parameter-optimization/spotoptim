...
print(f"\nNote: Uncertainty (σ) is low near sampled points, high in unexplored regions")
```
...
def rosenbrock_noisy_wrapper(X):
    return rosenbrock_noisy(X, noise_std=0.5)
...
print("\nComparison on noisy Rosenbrock (σ=0.5):")
print(f"{'Method':<30} {'Best Value':<15} {'Evaluations':<15}")
print(f"{'-'*60}")
print(f"{'Standard (no repeats)':<30} {result_std.fun:<15.6f} {result_std.nfev:<15}")
print(f"{'With repeats (no OCBA)':<30} {result_rep.fun:<15.6f} {result_rep.nfev:<15}")
print(f"{'With repeats + OCBA':<30} {result_ocba_comp.fun:<15.6f} {result_ocba_comp.nfev:<15}")
print(f"{'-'*60}")
print(f"{'True optimum':<30} {'0.0':<15}")

print("\nKey observations:")
print("  • Repeats help average out noise")
print("  • OCBA focuses evaluations on distinguishing best solutions")
print("  • More evaluations but better final result")
```
